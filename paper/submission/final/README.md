...
This folder contains generated delivery files for the Phase 43 conclusion-type
Paper11 route.

## Files

- `Paper11_formal_conclusion_manuscript.docx`: Word-processing export generated
  from `paper/submission/04_formal_conclusion_manuscript.md` with Pandoc.
...
and any required journal figure files.