...
Phase 50 reports directional sign-only cluster support, and Phase 51 reports magnitude-sensitive cluster support (`cluster_magnitude_support`). The current suitability-reward route
